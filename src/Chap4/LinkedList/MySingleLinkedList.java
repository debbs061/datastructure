 ...
 * SingleLinkedList : 단방향 리스트 (DoubleLinkedList도 있음)
 - 주로 하는 건 '삽입,삭제,검색'
 - 연결리스트가 Node들을 데이터로 저장하고 있는 개념은 아님
...
public class MySingleLinkedList<T> {
    ...
    public void addFirst(T item) { // 현재 연결리스트의 맨 앞에 새 노드를 넣음
    ...
    public void addAfter(Node<T> before, T item) {  // 어떤 노드 뒤에 새 노드를 넣음
